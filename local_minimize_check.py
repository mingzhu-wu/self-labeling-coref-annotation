```
This script originates from https://github.com/kentonl/e2e-coref/minimize.py.
```
...
def handle_bit(word_index, bit, stack, spans):
    ...
    if asterisk_idx >= 0:
        ...
        #open_parens = "("
        #close_parens = ")"
    #print(bit, open_parens, close_parens)
...
def handle_line(line, document_state, language, labels, stats):
    ...
    if begin_document_match:
        ...
        # the doc_key looks like this: 'bc/cctv/00/cctv_0000_003'
        document_state.doc_key = get_doc_key(begin_document_match.group(1), begin_document_match.group(2))
        return None
    elif line.startswith("#end document"):
        # why use assert_finalizable at the end of document
        try:
            document_state.assert_finalizable()
        except BaseException as e:
            print(document_state.coref_stacks)
        ...
        # need to figure out what is handle-bit used for
